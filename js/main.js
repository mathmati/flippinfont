...
import { QuoteEditor } from './QuoteEditor.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Font tile: Cycle through fonts
  if (fontSettingTile) {
    fontSettingTile.addEventListener('click', () => {
      fontSettingTile.classList.add('flipping');
  ...
  // Quote editor tile: Open quote editor
  if (quoteSettingTile) {
    quoteSettingTile.addEventListener('click', () => {
      quoteEditor.open();
    });
  }
