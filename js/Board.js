...
export class Board {
  constructor(containerEl, soundEngine, themeManager) {
    ...
    // Font tile
    this.fontSettingTile = document.createElement('div');
    this.fontSettingTile.className = 'settings-tile';
    ...
    this.quoteSettingTile.id = 'quote-setting-tile';
    this.quoteSettingTile.textContent = 'EDIT';
    
    // Fullscreen tile (primary button)
